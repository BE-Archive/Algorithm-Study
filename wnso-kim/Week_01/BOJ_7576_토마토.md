...
#### 생각
1. 익은 토마토(입력값 1)들을 기준으로 BFS를 활용한다. 
2. 기존 해당 문제를 풀었을 때는 BFS+Queue(LinkedList)를 사용했다. <br>
이번에 PriorityQueue를 활용해 시간과 메모리사용을 줄였다. 
![image](https://github.com/BE-Archive/Algorithm-Study/assets/109727039/6d33467e-c036-41d3-8d40-09fb1e276478)